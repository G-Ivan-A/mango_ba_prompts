...
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/mango-lk-manual/LK_manual_v-121часть-1.pdf","part":1,"pages":"87-89","global_pages":"87-89"}]'
...
> Трассировка: PDF §4.2.3.3.1 · сквозные стр. 87-89 · источники: ч.1 `kb/mango-product-docs/sources/mango-lk-manual/LK_manual_v-121часть-1.pdf` с.87-89.

Вид вкладки представлен на рисунке на следующей странице.

![Изображение, стр. 88](../images/90-vkladka-osnovnye-1.jpeg)

![Изображение, стр. 88](../images/90-vkladka-osnovnye-2.png)
