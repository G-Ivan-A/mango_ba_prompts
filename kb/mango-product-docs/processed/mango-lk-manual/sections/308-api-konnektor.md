---
id: mango-lk-manual-308-api-konnektor
doc_code: LK
...
source_part: "5"
source_pages: "ч.5: 98-104"
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/mango-lk-manual/LK_manual_v-121часть-5.pdf","part":5,"pages":"98-104","global_pages":"502-508"}]'
...
> Трассировка: PDF §4.6.7.3 · сквозные стр. 502-508 · источники: ч.5 `kb/mango-product-docs/sources/mango-lk-manual/LK_manual_v-121часть-5.pdf` с.98-104.

Используйте настройку «API Коннектор» для подключения к Виртуальной АТС различных внешних систем, например, таких как CRM или интернет-магазины. Вкладка API Коннектор Перейдите на вкладку API Коннектор, ознакомьтесь с возможностями API MANGO OFFICE и нажмите кнопку Подключить API Коннектор.

![Изображение, стр. 503](../images/308-api-konnektor-1.jpeg)

![Изображение, стр. 503](../images/308-api-konnektor-2.jpeg)
...
![Изображение, стр. 503](../images/308-api-konnektor-3.png)
...
![Изображение, стр. 504](../images/308-api-konnektor-4.jpeg)

![Изображение, стр. 504](../images/308-api-konnektor-5.png)

Дополнительные параметры API

![Изображение, стр. 504](../images/308-api-konnektor-6.png)
...
![Изображение, стр. 505](../images/308-api-konnektor-7.jpeg)

![Изображение, стр. 505](../images/308-api-konnektor-8.png)
...
![Изображение, стр. 506](../images/308-api-konnektor-9.jpeg)

примеры использования приведены в справке, вызываемой при наведении курсора

![Изображение, стр. 506](../images/308-api-konnektor-10.png)
...
![Изображение, стр. 507](../images/308-api-konnektor-11.jpeg)
...
![Изображение, стр. 507](../images/308-api-konnektor-12.png)

![Изображение, стр. 507](../images/308-api-konnektor-13.png)
...
![Изображение, стр. 508](../images/308-api-konnektor-14.jpeg)
...
![Изображение, стр. 508](../images/308-api-konnektor-15.png)
