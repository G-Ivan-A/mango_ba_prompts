...
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/mdialogi-api/Manual_API_Mango_Dialogi.pdf","part":1,"pages":"13-14","global_pages":"13-14"}]'
...
> Трассировка: PDF §2.3.5 · сквозные стр. 13-14 · источники: ч.1 `kb/mango-product-docs/sources/mdialogi-api/Manual_API_Mango_Dialogi.pdf` с.13-14.
