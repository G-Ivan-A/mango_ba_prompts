---
id: vpbx-api-212-rabota-s-obrascheniyami-v-kontakt-centre
doc_code: VPBXAPI
...
section: "4.8"
pdf_section: "4.8"
title: "Работа с обращениями в Контакт-центре"
pdf_heading: "4.8 Работа с обращениями в Контакт-центре"
pages: "295"
...
ai-generated: true
---
# 4.8. Работа с обращениями в Контакт-центре

> Трассировка: PDF §4.8 · сквозные стр. 295 · источники: ч.1 `kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.295.
