---
id: vpbx-api-11-obschie-polozheniya-o-vzaimodeystvii-sis
doc_code: VPBXAPI
...
pdf_heading: "2 Общие положения о взаимодействии систем"
pages: "11"
...
ai-generated: true
---
# 2. Общие положения о взаимодействии систем

> Трассировка: PDF §2 · сквозные стр. 11 · источники: ч.1 `kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.11.
