---
id: vpbx-api-75-zapros-spiska-sotrudnikov-vats
doc_code: VPBXAPI
...
source_part: "1"
source_pages: "ч.1: 101-109"
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf","part":1,"pages":"101-109","global_pages":"101-109"}]'
...
> Трассировка: PDF §3.7.1 · сквозные стр. 101-109 · источники: ч.1 `kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.101-109.
...
| --- | --- | --- | --- | --- | --- |
|  | 1 | 2 |  |  |  |
| 1 | extension |  |  | Нет | Идентификатор сотрудника ВАТС, настройки<br>которого запрашиваются. Для получения<br>полного списка сотрудников параметр не<br>передается |
| 2 | ext_fields |  | array<br>[string,string,<br>...] | Нет | Тип данных array [string,string, ...], можно<br>указать список дополнительных полей в<br>ответе |
| 2.1 |  | general.user_id |  |  | id сотрудника |
| 2.2 |  | general.sips |  |  | Массив SIP-учеток сотрудника |
| 2.3 |  | groups |  |  | Группы в которых состоит сотрудник (id-<br>номер группы) |
| 2.4 |  | general.access_role_id |  |  | Id-номер роли сотрудника |
| 2.5 |  | telephony.dial_alg |  |  | Алгоритм дозвона |
| 2.6 |  | telephony.numbers.sc<br>hedule |  |  | Расписание в формате аналогичного запроса в<br>общей шине |
| 2.7 |  | telephony.line_id |  |  | Исходящий номер (значение, id линии) |
| 2.8 |  | telephony.trunk_num<br>ber_id |  |  | id номера sip-trunk'a исходящего номера;<br>возвращается trunk_number_id: integer - id<br>номера sip-trunk'a исходящего номера |
| 2.9 |  | general.mobile | string |  | Мобильный телефон |
| 2.10 |  | general.login | string |  | Логин |
| 2.11 |  | general.use_status | string |  | Учитывать статус сотрудника в Контакт-<br>центре при распределении вызовов на него |
| 2.12 |  | general.use_cc_numb<br>ers | string |  | Принимать вызовы на номер(а) выбранные в<br>Контакт-центре |
...
| "use_status": 0,<br>"use_cc_numbers": 0,<br>"sips":<br>[ |
| {<br>"number": "AAA25@mangosip.ru"<br>}, |
| {<br>"number": "AAA25AA@mangosip.ru"<br>},<br>{<br>"number": "AAA25B@mangosip.ru"<br>}<br>]<br>},<br>"telephony":<br>{<br>"extension": "23",<br>"outgoingline": "sip:user1@wer.mangosip.ru",<br>"numbers":<br>[<br>{ |
| "number": "skype:25A25",<br>"protocol": "skype",<br>"order": 0, |
| "wait_sec": 120,<br>"status": "on",<br>"schedule": |
| [<br>]<br>}, |
| {<br>"number: " "123654123",<br>"number_normalized": "123654123",<br>"protocol": "tel",<br>"order": 1,<br>"wait_sec": 120, |
