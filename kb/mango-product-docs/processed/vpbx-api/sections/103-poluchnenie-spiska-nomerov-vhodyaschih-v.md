...
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf","part":1,"pages":"140-142","global_pages":"140-142"}]'
...
> Трассировка: PDF §3.8.2.2 · сквозные стр. 140-142 · источники: ч.1 `kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.140-142.
