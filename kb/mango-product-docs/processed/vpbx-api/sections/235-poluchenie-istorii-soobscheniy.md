...
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf","part":1,"pages":"316-318","global_pages":"316-318"}]'
...
> Трассировка: PDF §4.10.2.5 · сквозные стр. 316-318 · источники: ч.1 `kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.316-318.
