...
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf","part":1,"pages":"72-88","global_pages":"72-88"}]'
...
> Трассировка: PDF §3.4.2.3 · сквозные стр. 72-88 · источники: ч.1 `kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.72-88.
