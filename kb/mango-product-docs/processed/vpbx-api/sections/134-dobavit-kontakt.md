...
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf","part":1,"pages":"179-186","global_pages":"179-186"}]'
...
> Трассировка: PDF §3.9.3.4 · сквозные стр. 179-186 · источники: ч.1 `kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.179-186.
