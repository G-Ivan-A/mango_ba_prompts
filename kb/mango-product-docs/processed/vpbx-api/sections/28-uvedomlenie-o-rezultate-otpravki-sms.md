...
source_part: "1"
source_pages: "ч.1: 22"
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf","part":1,"pages":"22","global_pages":"22"}]'
...
> Трассировка: PDF §3.1.3 · сквозные стр. 22 · источники: ч.1 `kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.22.
