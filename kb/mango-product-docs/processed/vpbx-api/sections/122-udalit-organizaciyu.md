...
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf","part":1,"pages":"159-160","global_pages":"159-160"}]'
...
> Трассировка: PDF §3.9.1.6 · сквозные стр. 159-160 · источники: ч.1 `kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.159-160.
