...
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf","part":1,"pages":"120-122","global_pages":"120-122"}]'
...
> Трассировка: PDF §3.7.9 · сквозные стр. 120-122 · источники: ч.1 `kb/mango-product-docs/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.120-122.
