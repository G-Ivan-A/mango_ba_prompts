---
id: rukovodstvo-polzovatelya-rechevaya-anali-79-sso-single-sign-on
...
source_part: "1"
source_pages: "ч.1: 129-130"
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/speech-analytics/RECHEVAYA-ANALITIKA_c-KATS_v.1.26.18.pdf","part":1,"pages":"129-130","global_pages":"129-130"}]'
...
> Трассировка: PDF §7.3.6 · сквозные стр. 129-130 · источники: ч.1 `kb/mango-product-docs/sources/speech-analytics/RECHEVAYA-ANALITIKA_c-KATS_v.1.26.18.pdf` с.129-130.
...
Использование SSO позволяет централизованно управлять доступом пользователей и повысить уровень безопасности авторизации.

![Изображение, стр. 130](../images/79-sso-single-sign-on-2.png)
