---
id: rukovodstvo-polzovatelya-rechevaya-anali-73-poluchit-detalizaciyu-sovershennyh-razgo
...
pdf_heading: "9.1.5. Получить детализацию совершенных разговоров"
pages: "117-118"
...
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/speech-analytics/RECHEVAYA-ANALITIKA_Skoring_Rukovodstvo-polzovatelya_v.1.26.15.pdf","part":1,"pages":"117-118","global_pages":"117-118"}]'
...
> Трассировка: PDF §9.1.5 · сквозные стр. 117-118 · источники: ч.1 `kb/mango-product-docs/sources/speech-analytics/RECHEVAYA-ANALITIKA_Skoring_Rukovodstvo-polzovatelya_v.1.26.15.pdf` с.117-118.
...
![Изображение, стр. 118](../images/73-poluchit-detalizaciyu-sovershennyh-razgo-1.png)

| 8 800 555 55 22, mango-office.ru |  |
| --- | --- |
|  | mango@mangotele.com |

![Изображение, стр. 118](../images/73-poluchit-detalizaciyu-sovershennyh-razgo-2.png)
