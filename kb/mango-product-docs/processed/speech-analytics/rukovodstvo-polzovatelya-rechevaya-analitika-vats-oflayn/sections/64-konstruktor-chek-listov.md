---
id: rukovodstvo-polzovatelya-rechevaya-anali-64-konstruktor-chek-listov
...
pdf_heading: "9.4.1 Конструктор чек-листов"
pages: "96-102"
source: kb/mango-product-docs/sources/speech-analytics/RECHEVAYA-ANALITIKA_VATS-_-Skoring-1.26.18.pdf
source_part: "1"
source_pages: "ч.1: 96-102"
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/speech-analytics/RECHEVAYA-ANALITIKA_VATS-_-Skoring-1.26.18.pdf","part":1,"pages":"96-102","global_pages":"96-102"}]'
...
ai-generated: true
---
# 9.4.1. Конструктор чек-листов

> Трассировка: PDF §9.4.1 · сквозные стр. 96-102 · источники: ч.1 `kb/mango-product-docs/sources/speech-analytics/RECHEVAYA-ANALITIKA_VATS-_-Skoring-1.26.18.pdf` с.96-102.
...
![Изображение, стр. 98](../images/64-konstruktor-chek-listov-6.png)

Речевая аналитика. ВАТС & Офлайн скоринг | v.1.26.18 98

![Изображение, стр. 99](../images/64-konstruktor-chek-listov-7.png)
...
![Изображение, стр. 99](../images/64-konstruktor-chek-listov-8.png)
...
![Изображение, стр. 100](../images/64-konstruktor-chek-listov-11.png)
