...
source_part: "4"
source_pages: "ч.4: 84-87"
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/mango-cc-manual/CC_manual_1.26.23-part-4.pdf","part":4,"pages":"84-87","global_pages":"387-390"}]'
...
> Трассировка: PDF §12.3.1 · сквозные стр. 387-390 · источники: ч.4 `kb/mango-product-docs/sources/mango-cc-manual/CC_manual_1.26.23-part-4.pdf` с.84-87.

![Изображение, стр. 388](../images/138-effektivnost-sotrudnikov-1.png)
...
![Изображение, стр. 388](../images/138-effektivnost-sotrudnikov-2.png)
...
![Изображение, стр. 389](../images/138-effektivnost-sotrudnikov-4.png)
...
![Изображение, стр. 389](../images/138-effektivnost-sotrudnikov-6.png)

При наличии записи разговора в верхней части формы содержится панель встроенного плеера.

![Изображение, стр. 390](../images/138-effektivnost-sotrudnikov-7.png)
