...
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/mango-cc-manual/CC_manual_1.26.23-part-1.pdf","part":1,"pages":"30-32","global_pages":"30-32"}]'
...
> Трассировка: PDF §2.3.3 · сквозные стр. 30-32 · источники: ч.1 `kb/mango-product-docs/sources/mango-cc-manual/CC_manual_1.26.23-part-1.pdf` с.30-32.
...
![Изображение, стр. 31](../images/10-zakazy-obratnogo-zvonka-1.png)

![Изображение, стр. 31](../images/10-zakazy-obratnogo-zvonka-2.png)

В зависимости от типа виджета (ручной, автоматический) в мониторе очереди выводится различная информация.

![Изображение, стр. 32](../images/10-zakazy-obratnogo-zvonka-3.png)
