...
source_part: "3"
source_pages: "ч.3: 37-40"
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/mango-cc-manual/CC_manual_1.26.23-part-3.pdf","part":3,"pages":"37-40","global_pages":"239-242"}]'
...
> Трассировка: PDF §7.5.2 · сквозные стр. 239-242 · источники: ч.3 `kb/mango-product-docs/sources/mango-cc-manual/CC_manual_1.26.23-part-3.pdf` с.37-40.
...
![Изображение, стр. 239](../images/96-tekst-1.png)
...
![Изображение, стр. 240](../images/96-tekst-2.png)

![Изображение, стр. 240](../images/96-tekst-3.png)
...
![Изображение, стр. 241](../images/96-tekst-4.png)
...
![Изображение, стр. 242](../images/96-tekst-5.png)
