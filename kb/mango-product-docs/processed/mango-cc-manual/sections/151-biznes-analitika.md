---
id: mango-cc-manual-151-biznes-analitika
doc_code: CC
...
source_part: "5"
source_pages: "ч.5: 15-18"
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/mango-cc-manual/CC_manual_1.26.23-part-5.pdf","part":5,"pages":"15-18","global_pages":"419-422"}]'
...
> Трассировка: PDF §15 · сквозные стр. 419-422 · источники: ч.5 `kb/mango-product-docs/sources/mango-cc-manual/CC_manual_1.26.23-part-5.pdf` с.15-18.
...
![Изображение, стр. 419](../images/151-biznes-analitika-1.png)

![Изображение, стр. 419](../images/151-biznes-analitika-2.png)

Инструмент включает две группы отчетов, разделенные на подгруппы в зависимости от типа вызова: Продажи o Входящие

![Изображение, стр. 420](../images/151-biznes-analitika-3.png)
...
![Изображение, стр. 421](../images/151-biznes-analitika-4.png)

![Изображение, стр. 421](../images/151-biznes-analitika-5.png)
...
![Изображение, стр. 421](../images/151-biznes-analitika-6.png)
...
![Изображение, стр. 422](../images/151-biznes-analitika-7.png)
