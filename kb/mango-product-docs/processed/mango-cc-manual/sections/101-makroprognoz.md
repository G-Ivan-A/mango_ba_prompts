...
source_part: "3"
source_pages: "ч.3: 54-56"
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/mango-cc-manual/CC_manual_1.26.23-part-3.pdf","part":3,"pages":"54-56","global_pages":"256-258"}]'
...
> Трассировка: PDF §8.2.1 · сквозные стр. 256-258 · источники: ч.3 `kb/mango-product-docs/sources/mango-cc-manual/CC_manual_1.26.23-part-3.pdf` с.54-56.

![Изображение, стр. 257](../images/101-makroprognoz-1.png)
...
![Изображение, стр. 257](../images/101-makroprognoz-2.png)
...
![Изображение, стр. 258](../images/101-makroprognoz-3.png)
