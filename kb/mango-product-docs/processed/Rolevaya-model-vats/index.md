...
> Источник: `kb/mango-product-docs/sources/Rolevaya-model-vats/Rolevaya-model-VATS_1_26_08.pdf` · извлечено: pdfplumber 0.11.10 ·
...
| --- | --- | --- | --- | --- | ---: | --- |
| — | Титульная часть | [sections/00-titulnaya-chast.md](sections/00-titulnaya-chast.md) | 1-4 | ч.1 с.1-4 | 1720 | РУКОВОДСТВО |
| 1 | Общие сведения | [sections/01-obschie-svedeniya.md](sections/01-obschie-svedeniya.md) | 4-5 | ч.1 с.4-5 | 522 | Ролевая модель предназначена для разграничения прав доступа пользователей в системе. |
| 2 | Стандартные роли | [sections/02-standartnye-roli.md](sections/02-standartnye-roli.md) | 5-7 | ч.1 с.5-7 | 979 | В Виртуальной АТС MANGO OFFICE предусмотрены стандартные системные роли. |
| 3 | Управление ролями | [sections/03-upravlenie-rolyami.md](sections/03-upravlenie-rolyami.md) | 7 | ч.1 с.7 | 459 | Управление ролями выполняется в разделе: |
| 3.1 | Просмотр списка ролей | [sections/04-prosmotr-spiska-roley.md](sections/04-prosmotr-spiska-roley.md) | 7-8 | ч.1 с.7-8 | 264 | Список ролей отображается на странице управления ролями. |
| 3.2 | Создание роли | [sections/05-sozdanie-roli.md](sections/05-sozdanie-roli.md) | 8-9 | ч.1 с.8-9 | 477 | Создание роли позволяет определить новый набор прав доступа для пользователей системы. |
| 3.3 | Создание роли путем копирования | [sections/06-sozdanie-roli-putem-kopirovaniya.md](sections/06-sozdanie-roli-putem-kopirovaniya.md) | 9 | ч.1 с.9 | 169 | копирования |
| 3.3.1 | Копировать роль без запретов на изменение настроек | [sections/07-kopirovat-rol-bez-zapretov-na-izmenenie.md](sections/07-kopirovat-rol-bez-zapretov-na-izmenenie.md) | 9-11 | ч.1 с.9-11 | 942 | изменение настроек |
| 3.3.2 | Копировать роль | [sections/08-kopirovat-rol.md](sections/08-kopirovat-rol.md) | 11-12 | ч.1 с.11-12 | 543 | Данная строка меню доступна для нажатия если у пользователя активировано право доступа |
| 3.4 | Удаление роли | [sections/09-udalenie-roli.md](sections/09-udalenie-roli.md) | 12 | ч.1 с.12 | 221 | Удалить можно только пользовательские роли. |
| 3.5 | Сбросить настройки роли | [sections/10-sbrosit-nastroyki-roli.md](sections/10-sbrosit-nastroyki-roli.md) | 12-14 | ч.1 с.12-14 | 485 | Если права доступа роли были изменены, их можно вернуть к исходным значениям. |
| 4 | Настройка прав доступа роли | [sections/11-nastroyka-prav-dostupa-roli.md](sections/11-nastroyka-prav-dostupa-roli.md) | 14-16 | ч.1 с.14-16 | 1536 | роли |
| 4.1 | Гибкая настройка прав доступа с учетом ролей объекта | [sections/12-gibkaya-nastroyka-prav-dostupa-s-uchetom.md](sections/12-gibkaya-nastroyka-prav-dostupa-s-uchetom.md) | 16-19 | ч.1 с.16-19 | 1449 | учетом ролей объекта |
...
- Источник БЗ, часть 1: `kb/mango-product-docs/sources/Rolevaya-model-vats/Rolevaya-model-VATS_1_26_08.pdf`
