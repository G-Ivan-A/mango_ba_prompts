---
id: android-user-guide-22-kak-otpravit-email
...
source_refs: '[{"source_pdf":"kb/mango-product-docs/sources/mtalker/UserGuide_mTalker_4Mobile.pdf","part":1,"pages":"14-15","global_pages":"14-15"}]'
...
> Трассировка: PDF §— · сквозные стр. 14-15 · источники: ч.1 `kb/mango-product-docs/sources/mtalker/UserGuide_mTalker_4Mobile.pdf` с.14-15.
...
– нажмите на кнопку . Будет запущена программа для отправки email; – нажмите на email в блоке “О контакте”. Будет запущена программа для отправки email. Mango Talker для ОС Android. Руководство пользователя | Версия от 23.08.2024
