...
source_refs: '[{"source_pdf":"kb/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf","part":1,"pages":"46-49","global_pages":"46-49"}]'
...
> Трассировка: PDF §3.2.7 · сквозные стр. 46-49 · источники: ч.1 `kb/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.46-49.
...
> ⚠️ **ПРОБЕЛ ИЗВЛЕЧЕНИЯ**: на странице нет текстового слоя (скан/изображение) — содержимое не извлечено и не додумано; проверить в источнике вручную. (Источник: `MangoOffice_VPBX_API_v1.9.pdf`, стр. 47)
