...
source_refs: '[{"source_pdf":"kb/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf","part":1,"pages":"50-55","global_pages":"50-55"}]'
...
> Трассировка: PDF §3.2.8 · сквозные стр. 50-55 · источники: ч.1 `kb/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.50-55.
...
> ⚠️ **ПРОБЕЛ ИЗВЛЕЧЕНИЯ**: на странице нет текстового слоя (скан/изображение) — содержимое не извлечено и не додумано; проверить в источнике вручную. (Источник: `MangoOffice_VPBX_API_v1.9.pdf`, стр. 52)

> ⚠️ **ПРОБЕЛ ИЗВЛЕЧЕНИЯ**: на странице нет текстового слоя (скан/изображение) — содержимое не извлечено и не додумано; проверить в источнике вручную. (Источник: `MangoOffice_VPBX_API_v1.9.pdf`, стр. 54)
