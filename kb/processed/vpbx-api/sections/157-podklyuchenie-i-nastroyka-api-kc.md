---
id: vpbx-api-157-podklyuchenie-i-nastroyka-api-kc
doc_code: VPBXAPI
...
source_refs: '[{"source_pdf":"kb/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf","part":1,"pages":"213-214","global_pages":"213-214"}]'
...
> Трассировка: PDF §4.2 · сквозные стр. 213-214 · источники: ч.1 `kb/sources/vpbx-api/MangoOffice_VPBX_API_v1.9.pdf` с.213-214.
...
![Изображение, стр. 213](../images/157-podklyuchenie-i-nastroyka-api-kc-1.jpeg)

Рисунок 3 - если в разделе "Дополнительные сервисы" НЕ отображен блок "Открытое API":

![Изображение, стр. 214](../images/157-podklyuchenie-i-nastroyka-api-kc-2.jpeg)
...
![Изображение, стр. 214](../images/157-podklyuchenie-i-nastroyka-api-kc-3.jpeg)
