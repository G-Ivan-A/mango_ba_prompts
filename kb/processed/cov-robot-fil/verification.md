...
doc_code: ROBOTFIL
source_document: "Модуль ЦОВ Робот Фил 2,0_manual_v7.26.28.pdf"
...
# Отчёт перекрёстной проверки — Модуль ЦОВ «Робот Фил 2,0». Руководство пользователя
...
| Метрика | Значение |
| --- | ---: |
| Проверено критических токенов | 515 |
