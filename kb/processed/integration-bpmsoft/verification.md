...
doc_code: INTBPM
source_document: "Mango_office_integration_BPMSoft.pdf"
...
# Отчёт перекрёстной проверки — Интеграция Виртуальной АТС и BPMSoft. Руководство по интеграции
...
| Метрика | Значение |
| --- | ---: |
| Проверено критических токенов | 463 |
