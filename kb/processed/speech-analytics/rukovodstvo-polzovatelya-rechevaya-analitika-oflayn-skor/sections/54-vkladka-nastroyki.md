---
id: rukovodstvo-polzovatelya-rechevaya-anali-54-vkladka-nastroyki
...
source_refs: '[{"source_pdf":"kb/sources/speech-analytics/RECHEVAYA-ANALITIKA_Skoring_Rukovodstvo-polzovatelya_v.1.26.15.pdf","part":1,"pages":"91-93","global_pages":"91-93"}]'
...
> Трассировка: PDF §7.3.1 · сквозные стр. 91-93 · источники: ч.1 `kb/sources/speech-analytics/RECHEVAYA-ANALITIKA_Skoring_Rukovodstvo-polzovatelya_v.1.26.15.pdf` с.91-93.

![Изображение, стр. 91](../images/54-vkladka-nastroyki-1.png)

Пароль администратора ЛС Для изменения пароля администратора нажмите на кнопку Изменить пароль. Подтвердите отправку письма на зарегистрированный E-mail. На указанный E-mail отправляется письмо с уникальной одноразовой ссылкой для восстановления пароля и инструкцией. Речевая аналитика. Скоринг | v.1.26.15 91

![Изображение, стр. 92](../images/54-vkladka-nastroyki-2.png)
