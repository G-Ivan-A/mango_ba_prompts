---
id: rukovodstvo-polzovatelya-rechevaya-anali-45-blok-tablicy-razgovory-detalizaciya
...
pdf_heading: "8.2.3. Блок таблицы Разговоры, детализация"
pages: "70-74"
source: kb/sources/speech-analytics/RECHEVAYA-ANALITIKA_1.26.18.pdf
source_part: "1"
source_pages: "ч.1: 70-74"
source_refs: '[{"source_pdf":"kb/sources/speech-analytics/RECHEVAYA-ANALITIKA_1.26.18.pdf","part":1,"pages":"70-74","global_pages":"70-74"}]'
...
ai-generated: true
---
# 8.2.3. Блок таблицы Разговоры, детализация

> Трассировка: PDF §8.2.3 · сквозные стр. 70-74 · источники: ч.1 `kb/sources/speech-analytics/RECHEVAYA-ANALITIKA_1.26.18.pdf` с.70-74.

Табличная часть отчета состоит из трех разделов: Речевая аналитика | v.1.26.18 70

![Изображение, стр. 71](../images/45-blok-tablicy-razgovory-detalizaciya-1.png)
...
![Изображение, стр. 71](../images/45-blok-tablicy-razgovory-detalizaciya-2.jpeg)

Таблица содержит следующие столбцы (рассмотрим пример для среза «Сотрудники»): • Сотрудник – имя сотрудника ВАТС. • Клиент – количество уникальных внешних номеров (не привязанных ни к одному из сотрудников ВАТС) с которыми у выбранного сотрудника за выбранный период состоялся разговор. Если в качестве источника записи выбран тип разговора «телефонные разговоры», то в списке содержится информация о наименовании группы каналов и канале коммуникации разговора. По каждому пункту списка доступна детализация звонков с записями разговоров, а также текста диалога в канале коммуникации (если на ВАТС подключены соответствующие услуги). • Дата – диапазон дат в которые у выбранного сотрудника имеются распознанные разговоры. Речевая аналитика | v.1.26.18 71

![Изображение, стр. 72](../images/45-blok-tablicy-razgovory-detalizaciya-3.png)
...
![Изображение, стр. 74](../images/45-blok-tablicy-razgovory-detalizaciya-13.png)
