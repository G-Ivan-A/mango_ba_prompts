...
source_refs: '[{"source_pdf":"kb/sources/mango-lk-manual/LK_manual_v-123.pdf","part":1,"pages":"61-62","global_pages":"61-62"}]'
...
> Трассировка: PDF §4 · сквозные стр. 61-62 · источники: ч.1 `kb/sources/mango-lk-manual/LK_manual_v-123.pdf` с.61-62.

Виджет представляет список всех сотрудников, созданных в текущей ВАТС на момент просмотра виджета.

![Изображение, стр. 61](../images/64-vidzhet-sotrudniki-1.jpeg)
...
![Изображение, стр. 62](../images/64-vidzhet-sotrudniki-3.jpeg)
