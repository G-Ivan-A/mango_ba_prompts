---
id: mango-lk-manual-295-komnaty-konferenciy
doc_code: LK
...
source_part: "1"
source_pages: "ч.1: 472-474"
source_refs: '[{"source_pdf":"kb/sources/mango-lk-manual/LK_manual_v-123.pdf","part":1,"pages":"472-474","global_pages":"472-474"}]'
...
> Трассировка: PDF §4.6.4.2 · сквозные стр. 472-474 · источники: ч.1 `kb/sources/mango-lk-manual/LK_manual_v-123.pdf` с.472-474.
...
![Изображение, стр. 473](../images/295-komnaty-konferenciy-1.jpeg)

![Изображение, стр. 473](../images/295-komnaty-konferenciy-2.png)

По умолчанию наименованием комнаты является «Комната конференции» и

![Изображение, стр. 473](../images/295-komnaty-konferenciy-3.png)

порядковый номер. Для редактирования наименования нажмите . Введите новое имя

![Изображение, стр. 473](../images/295-komnaty-konferenciy-4.png)
...
![Изображение, стр. 474](../images/295-komnaty-konferenciy-5.jpeg)
...
![Изображение, стр. 474](../images/295-komnaty-konferenciy-6.jpeg)

Для удаления виртуальной комнаты конференций следует в списке комнат щелкнуть по

![Изображение, стр. 474](../images/295-komnaty-konferenciy-7.png)
