...
pdf_section: "4.4.6.3"
title: "Роботы"
pdf_heading: "4.4.6.3 Роботы"
pages: "174-175"
source: kb/sources/mango-lk-manual/LK_manual_v-121часть-2.pdf
source_part: "2"
source_pages: "ч.2: 73-74"
source_refs: '[{"source_pdf":"kb/sources/mango-lk-manual/LK_manual_v-121часть-2.pdf","part":2,"pages":"73-74","global_pages":"174-175"}]'
...
> Трассировка: PDF §4.4.6.3 · сквозные стр. 174-175 · источники: ч.2 `kb/sources/mango-lk-manual/LK_manual_v-121часть-2.pdf` с.73-74.
...
![Изображение, стр. 174](../images/122-roboty-1.png)
...
![Изображение, стр. 174](../images/122-roboty-2.png)

, служебная роль – «Робот».

![Изображение, стр. 174](../images/122-roboty-3.png)

![Изображение, стр. 174](../images/122-roboty-4.png)

По клику на имени робота в списке открывается карточка робота.

![Изображение, стр. 175](../images/122-roboty-5.jpeg)
