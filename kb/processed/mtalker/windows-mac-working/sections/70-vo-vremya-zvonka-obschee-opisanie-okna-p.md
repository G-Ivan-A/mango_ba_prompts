---
id: windows-mac-working-70-vo-vremya-zvonka-obschee-opisanie-okna-p
...
source_refs: '[{"source_pdf":"kb/sources/mtalker/UserGuide_Windows_mTalker_ch1_Working.11.06.26.pdf","part":1,"pages":"67-69","global_pages":"67-69"}]'
...
![Изображение, стр. 67](../images/70-vo-vremya-zvonka-obschee-opisanie-okna-p-1.png)
...
![Изображение, стр. 67](../images/70-vo-vremya-zvonka-obschee-opisanie-okna-p-2.png)

Клавиши. Отображение экранной клавиатуры в окне проведения сеанса связи.

![Изображение, стр. 67](../images/70-vo-vremya-zvonka-obschee-opisanie-okna-p-3.png)

Запись. Включение/выключение записи разговора. Данная функция может быть не доступна, в зависимости от настроек вашей ВАТС.

![Изображение, стр. 67](../images/70-vo-vremya-zvonka-obschee-opisanie-okna-p-4.png)

Устройства. Выбор динамиков и микрофона, которые вы будете использовать во время звонка.

![Изображение, стр. 67](../images/70-vo-vremya-zvonka-obschee-opisanie-okna-p-5.png)

Перевод. Перевод вызова на того или иного абонента, записанного в телефонной книге.

![Изображение, стр. 67](../images/70-vo-vremya-zvonka-obschee-opisanie-okna-p-6.png)

Переключить. Переключение звонка между вашими устройствами, на которых выполнен вход в ваш аккаунт MTalker.

![Изображение, стр. 67](../images/70-vo-vremya-zvonka-obschee-opisanie-okna-p-7.png)

Удержание. Удержание вызова

![Изображение, стр. 67](../images/70-vo-vremya-zvonka-obschee-opisanie-okna-p-8.png)
...
![Изображение, стр. 67](../images/70-vo-vremya-zvonka-obschee-opisanie-okna-p-9.png)
