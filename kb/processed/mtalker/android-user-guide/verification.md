...
source_document: "UserGuide_mTalker_4Mobile 11.06.26.pdf"
...
# Отчёт перекрёстной проверки — Mango Talker для Android - Руководство пользователя
...
| Метрика | Значение |
| --- | ---: |
| Проверено критических токенов | 313 |
