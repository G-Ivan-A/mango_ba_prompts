---
id: mango-cc-manual-75-nastroyka-poley
doc_code: CC
...
source_refs: '[{"source_pdf":"kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf","part":1,"pages":"337-339","global_pages":"337-339"}]'
...
> Трассировка: PDF §11.2 · сквозные стр. 337-339 · источники: ч.1 `kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf` с.337-339.
...
![Изображение, стр. 337](../images/75-nastroyka-poley-1.jpeg)
...
![Изображение, стр. 338](../images/75-nastroyka-poley-2.png)

![Изображение, стр. 338](../images/75-nastroyka-poley-3.jpeg)
...
![Изображение, стр. 338](../images/75-nastroyka-poley-4.png)
...
![Изображение, стр. 338](../images/75-nastroyka-poley-5.png)
...
![Изображение, стр. 339](../images/75-nastroyka-poley-6.png)

![Изображение, стр. 339](../images/75-nastroyka-poley-7.png)

На примере ниже показано отображение данных поля Ссылка в карточке обращения (1), а

![Изображение, стр. 339](../images/75-nastroyka-poley-8.jpeg)
