---
id: mango-cc-manual-16-dashboard
doc_code: CC
...
source_refs: '[{"source_pdf":"kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf","part":1,"pages":"117-119","global_pages":"117-119"}]'
...
> Трассировка: PDF §3 · сквозные стр. 117-119 · источники: ч.1 `kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf` с.117-119.
...
![Изображение, стр. 118](../images/16-dashboard-3.png)
...
![Изображение, стр. 118](../images/16-dashboard-4.png)
...
![Изображение, стр. 119](../images/16-dashboard-5.png)
...
![Изображение, стр. 119](../images/16-dashboard-6.png)

![Изображение, стр. 119](../images/16-dashboard-7.png)

Клик по пиктограмме открывает окно дополнительных действий с Dashboard.

![Изображение, стр. 119](../images/16-dashboard-8.png)
