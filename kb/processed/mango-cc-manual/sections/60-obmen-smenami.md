---
id: mango-cc-manual-60-obmen-smenami
doc_code: CC
...
source_refs: '[{"source_pdf":"kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf","part":1,"pages":"262-266","global_pages":"262-266"}]'
...
> Трассировка: PDF §8.4 · сквозные стр. 262-266 · источники: ч.1 `kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf` с.262-266.

![Изображение, стр. 263](../images/60-obmen-smenami-1.png)
...
![Изображение, стр. 263](../images/60-obmen-smenami-2.jpeg)

Действия с запросом на обмен обозначены пиктограммами:

![Изображение, стр. 263](../images/60-obmen-smenami-3.png)

– отклонение запроса на обмен сменами.

![Изображение, стр. 263](../images/60-obmen-smenami-4.png)

– подтверждение запроса на обмен сменами.

![Изображение, стр. 263](../images/60-obmen-smenami-5.png)
...
![Изображение, стр. 264](../images/60-obmen-smenami-6.png)
...
![Изображение, стр. 264](../images/60-obmen-smenami-7.jpeg)
...
![Изображение, стр. 265](../images/60-obmen-smenami-8.png)
...
![Изображение, стр. 265](../images/60-obmen-smenami-9.png)
...
![Изображение, стр. 265](../images/60-obmen-smenami-10.png)
...
![Изображение, стр. 265](../images/60-obmen-smenami-11.jpeg)

![Изображение, стр. 266](../images/60-obmen-smenami-12.png)

| Чтобы обмен считался завершенным, участвующий в обмене сотрудник и руководитель |
| --- |
| должны подтвердить обмен. |

![Изображение, стр. 266](../images/60-obmen-smenami-13.png)
