...
source_part: "1"
source_pages: "ч.1: 274-276"
source_refs: '[{"source_pdf":"kb/sources/mango-cc-manual/CC_manual_1.26.23_compressed.pdf","part":1,"pages":"274-276","global_pages":"274-276"}]'
...
> Трассировка: PDF §8.5.2 · сквозные стр. 274-276 · источники: ч.1 `kb/sources/mango-cc-manual/CC_manual_1.26.23_compressed.pdf` с.274-276.
...
![Изображение, стр. 275](../images/106-proizvodstvennyy-kalendar-1.jpeg)

![Изображение, стр. 275](../images/106-proizvodstvennyy-kalendar-2.png)

Производственный календарь доступен только в тарифе PRO.

![Изображение, стр. 275](../images/106-proizvodstvennyy-kalendar-3.jpeg)
...
![Изображение, стр. 276](../images/106-proizvodstvennyy-kalendar-4.jpeg)
