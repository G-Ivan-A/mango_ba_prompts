---
id: mango-cc-manual-41-kalendar-zadach
doc_code: CC
...
source_refs: '[{"source_pdf":"kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf","part":1,"pages":"203-205","global_pages":"203-205"}]'
...
> Трассировка: PDF §6.1 · сквозные стр. 203-205 · источники: ч.1 `kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf` с.203-205.
...
![Изображение, стр. 204](../images/41-kalendar-zadach-1.png)

![Изображение, стр. 204](../images/41-kalendar-zadach-2.jpeg)
...
![Изображение, стр. 204](../images/41-kalendar-zadach-3.png)
...
![Изображение, стр. 205](../images/41-kalendar-zadach-4.png)
...
![Изображение, стр. 205](../images/41-kalendar-zadach-5.png)

При наведении курсора на блок задачи всплывает окно, содержащее краткую информацию о задаче.

![Изображение, стр. 205](../images/41-kalendar-zadach-6.jpeg)
