...
source_part: "1"
source_pages: "ч.1: 398-402"
source_refs: '[{"source_pdf":"kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf","part":1,"pages":"398-402","global_pages":"398-402"}]'
...
> Трассировка: PDF §13.3 · сквозные стр. 398-402 · источники: ч.1 `kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf` с.398-402.
...
![Изображение, стр. 398](../images/87-chaty-1.png)
...
![Изображение, стр. 398](../images/87-chaty-2.png)
...
![Изображение, стр. 399](../images/87-chaty-3.jpeg)

![Изображение, стр. 399](../images/87-chaty-4.png)
...
![Изображение, стр. 399](../images/87-chaty-5.png)

В списке чатов всегда присутствует чат Избранное - личный чат для отправки сообщений и заметок самому себе. В чате Избранное доступна отправка сообщений. Кнопки Пригласить в чат и Новая видеосвязь для этого чата недоступны, так как не применимы к переписке с самим собой. Клик по ФИО отправителя приводит к открытию карточки сотрудника.
...
![Изображение, стр. 400](../images/87-chaty-8.png)

собеседников из чата. Для этого следует щелкнуть по пиктограмме напротив имени

![Изображение, стр. 400](../images/87-chaty-9.png)
...
![Изображение, стр. 400](../images/87-chaty-10.jpeg)

изменения названия чата. Для этого следует щелкнуть по пиктограмме , указать новое название и нажать Enter либо щелкнуть по названию чата правой кнопкой мыши и выбрать пункт "Переименовать" в контекстном меню. Закрепление чатов • Чтобы закрепить чат, нажмите правой кнопкой мыши на его название в списке чатов и выберите пункт Закрепить. Закреплённый чат отображается над группой Сегодня и отмечается иконкой закрепления. Если закреплено несколько чатов, они сортируются по названию.

![Изображение, стр. 400](../images/87-chaty-11.png)

• Чтобы открепить чат, нажмите правой кнопкой мыши на его название и выберите пункт Открепить. Чат вернётся в список в соответствии со временем последнего сообщения. Ограничение на количество закреплённых чатов отсутствует.

| Закрепление чата синхронизируется между приложением Контакт-центр MANGO OFFICE |
| --- |
| и коммуникатором MANGO Talker: чат, закреплённый в одном приложении, автоматически |
| закрепляется и в другом. |

![Изображение, стр. 401](../images/87-chaty-12.jpeg)

Поиск сообщений в чатах

![Изображение, стр. 401](../images/87-chaty-13.png)

В чатах внутреннего общения Контакт-центра доступны два варианта поиска: 1. Поиск по списку чатов. После ввода искомого термина в поисковой строке (1) и клике на пиктограмму "лупа", в левом вертикальном меню списка чатов останутся только чаты, содержимое которых включает искомый термин. 2. Поиск в чате. После ввода искомого термина в поисковой строке (2) и клике на пиктограмму "лупа", в текущем чате будут отмечены все вхождения искомого термина. А общее количество вхождений отобразится справа от поисковой строки (3). Отправка, прием и хранение сообщений Сообщение отправляется при нажатии кнопки Отправить или клавиши Enter. Предусмотрена возможность отправки многострочных сообщений при помощи комбинаций Ctrl+Enter и Shift+Enter. Для того, чтобы добавить к текстовому сообщению "смайл", в процессе редактирования

![Изображение, стр. 401](../images/87-chaty-14.png)

сообщения щелкните по пиктограмме и выберите нужное изображение.

![Изображение, стр. 401](../images/87-chaty-15.jpeg)
...
![Изображение, стр. 401](../images/87-chaty-16.png)
...
<!-- изображение на стр. 402: байты не извлечены (PyMuPDF недоступен) -->
