---
id: mango-cc-manual-81-spisok-skriptov
doc_code: CC
...
source_refs: '[{"source_pdf":"kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf","part":1,"pages":"377-379","global_pages":"377-379"}]'
...
> Трассировка: PDF §12.1 · сквозные стр. 377-379 · источники: ч.1 `kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf` с.377-379.

При запуске модуль "Скрипты" открывается на списке скриптов. Вид рабочей области программы приведен на рисунке ниже.

![Изображение, стр. 378](../images/81-spisok-skriptov-1.png)

![Изображение, стр. 378](../images/81-spisok-skriptov-2.jpeg)
...
![Изображение, стр. 378](../images/81-spisok-skriptov-3.png)
...
![Изображение, стр. 379](../images/81-spisok-skriptov-4.png)
...
![Изображение, стр. 379](../images/81-spisok-skriptov-5.png)

![Изображение, стр. 379](../images/81-spisok-skriptov-6.jpeg)

| При удалении скрипта удаляются все его версии. Статистика по версиям скрипта не |
| --- |
| удаляется. |

![Изображение, стр. 379](../images/81-spisok-skriptov-7.png)
