---
id: mango-cc-manual-30-istoriya-sdelok
doc_code: CC
...
source_refs: '[{"source_pdf":"kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf","part":1,"pages":"179-182","global_pages":"179-182"}]'
...
> Трассировка: PDF §5.2 · сквозные стр. 179-182 · источники: ч.1 `kb/sources/mango-cc-manual/CC_manual_1.26.28.1.pdf` с.179-182.
...
![Изображение, стр. 180](../images/30-istoriya-sdelok-1.png)
...
![Изображение, стр. 180](../images/30-istoriya-sdelok-2.png)

Длительность произвольного периода не может превышать 31 день.

![Изображение, стр. 180](../images/30-istoriya-sdelok-3.jpeg)

рис.1. Блок фильтров Блок визуализаций отображает информацию по: • количеству сделок • сумме сделок

![Изображение, стр. 180](../images/30-istoriya-sdelok-4.jpeg)

рис.2. Блок визуализаций

![Изображение, стр. 180](../images/30-istoriya-sdelok-5.png)
...
![Изображение, стр. 180](../images/30-istoriya-sdelok-6.png)

рис.3. Табличная часть Предусмотрены следующие столбцы:

![Изображение, стр. 181](../images/30-istoriya-sdelok-7.png)
...
![Изображение, стр. 181](../images/30-istoriya-sdelok-8.png)
...
![Изображение, стр. 181](../images/30-istoriya-sdelok-9.png)
...
![Изображение, стр. 182](../images/30-istoriya-sdelok-10.png)

![Изображение, стр. 182](../images/30-istoriya-sdelok-11.png)

Сделка со статусом Не состоялась недоступна для редактирования. Карточка сделки промаркирована красным цветом.

![Изображение, стр. 182](../images/30-istoriya-sdelok-12.png)
