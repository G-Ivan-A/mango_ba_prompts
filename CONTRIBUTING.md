...
- **молчание = согласие:** если Фаундер мержит PR без комментариев, решения,
  включая обоснованные обходы scope, приняты;
- **комментарий + ручной перезапуск:** если Фаундер оставляет комментарий и
...
сохраняют human decision rights, не публикуют sensitive data и не создают
`research/` в споке.
