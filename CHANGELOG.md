...
### Added — Issue #281 реальный прогон 58093 (RUN-0026) как эмпирические данные

- Добавлен [`runs/2026/RUN-0026/`](runs/2026/RUN-0026/metadata.yaml) —
...
- Прогон оформлен как **один комплексный run с разметкой на 19 эпизодов** и
  ...
  [`outputs/README.md`](runs/2026/RUN-0026/outputs/README.md),
  [`outputs/steps/`](runs/2026/RUN-0026/outputs/steps).
