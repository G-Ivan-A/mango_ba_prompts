...
### Added — Issue #275 реальный прогон 1040 (RUN-0024) как Proof of Execution
...
- Вход сохранён вместе с происхождением: исходный JSON вложения, его SHA-256/MD5 и
  команды воспроизведения — [`inputs/README.md`](runs/2026/RUN-0024/inputs/README.md),
  дословный транскрипт — [`inputs/transcript.md`](runs/2026/RUN-0024/inputs/transcript.md),
  черновики БА обеих версий решения и реестр дефектов входа В1–В5 —
  [`inputs/raw-requirement.md`](runs/2026/RUN-0024/inputs/raw-requirement.md).
- Прогон **не является** согласованным документом и не является эталонным кейсом:
  [`outputs/final-artifact.md`](runs/2026/RUN-0024/outputs/final-artifact.md) помечен
...
- Обратной связи БА в выгрузке нет; вердикты восстановлены по наблюдаемому поведению,
  ...
  [`feedback/review-notes.md`](runs/2026/RUN-0024/feedback/review-notes.md).
- Метрики измерены по нативным полям `usage` провайдера, а не оценкой токенизатором
  ([`logs/metrics.md`](runs/2026/RUN-0024/logs/metrics.md)): 27 982 диалоговых токена
...
- Реестры обновлены: строка `RUN-0024` в [`runs/README.md`](runs/README.md) и запись
