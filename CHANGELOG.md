...
### Added — Issue #277 реальный прогон 1020 (RUN-0021): вопросы стейкхолдеру по интеграции OkDesk ↔ MANGO OFFICE
...
- Добавлена запись [`runs/2026/RUN-0021/`](runs/2026/RUN-0021/outputs/README.md) —
  ...
  ([`inputs/transcript.md`](runs/2026/RUN-0021/inputs/transcript.md)), вход —
  ad-hoc постановка БА без библиотечного промпта, разбор по эпизодам
  ([`outputs/steps/`](runs/2026/RUN-0021/outputs/steps/)) и итоговое состояние
...
- Зафиксированы три галлюцинации: Г1 (выдуманный механизм с «Лидом», опровергнут
  ...
  ([`logs/grounding-check.md`](runs/2026/RUN-0021/logs/grounding-check.md)).
- Измеренные метрики из полей провайдера
  ([`logs/turn-metrics.md`](runs/2026/RUN-0021/logs/turn-metrics.md)): 59 974 токена
