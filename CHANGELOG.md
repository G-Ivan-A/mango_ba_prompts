...
- Описаны роль проекта и инфраструктурная модель: операционка фаундера для
  автоматизации БА в Mango (телеком), GitHub как единственная платформа,
  AI-исполнитель (Конард) как основной инструмент — без серверной инфраструктуры
...
- [`README.md`](README.md) переформулирован под роль операционки фаундера;
  добавлены разделы «Роль проекта и границы» и «Принцип «качество системы
...
- [`docs/rfc-hub-integration.md`](docs/rfc-hub-integration.md): новый §1.1 «Два
  ...
  (обезличенные плейбуки); поток строго односторонний и неавтоматический.
