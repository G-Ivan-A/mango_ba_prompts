...
MANGO_OFFICIAL = "kb/mango-taxonomy/official-products.yaml"
MANGO_INTERNAL = "kb/mango-taxonomy/internal-registry.yaml"
MANGO_MAPPING = "kb/mango-taxonomy/product-mapping.yaml"
VOICE_ANALYSIS = "docs/analysis/2026-06-21-voice-digital-channels-comparison.md"
