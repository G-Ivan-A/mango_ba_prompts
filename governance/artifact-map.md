...
| `/governance/contracts-registry.md` | реестр | YAML-реестр provenance исполнимых контрактов; runtime-контракты ссылаются на записи только через `contract_registry_id`. | По необходимости | `governance/bcreq-fr-generation-contract.md`, `CHANGELOG.md` |
