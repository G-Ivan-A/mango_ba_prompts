...
| `/governance/contracts-registry.md` | реестр | L2-реестр source/provenance контрактов; L1-контракты хранят только `contract_registry_id`, без embedded L3 provenance. | По необходимости | `standards/executable-contract-standard.md`, `governance/bcreq-fr-generation-contract.md`, `runs/CONTRACT.md`, `kb/golden-examples/CONTRACT.md` |
