...
| `/governance/bcreq-fr-generation-contract.md` | контракт процесса | Исполнимый контракт AI-агента для генерации комплексного BCREQ-FR: разделы 1-7, RFC-184 scope-filter, taxonomy/product-doc traceability и итоговая валидация. | По необходимости | `standards/bcreq-process-standard.md`, `governance/rfc/bcreq-ft-scope-formation-rules-proposal.md`, `kb/industry-taxonomy/registry.json`, `kb/mango-taxonomy/registry.json` |
