...
w("related_artifacts:")
for a in ("kb/mango-taxonomy/registry.json", "kb/mango-taxonomy/registry.schema.json",
...
w("> Документ сгенерирован из живого реестра скриптом "
  ...
  "отражает [`kb/mango-taxonomy/registry.json`](../../kb/mango-taxonomy/registry.json) "
...
w()
w("Итог — единый файл [`kb/mango-taxonomy/registry.json`](../../kb/mango-taxonomy/registry.json) "
