...
По [`docs/ba-processes/00-index.md`](../../ba-processes/00-index.md) задача
...
| --- | --- | --- | --- | --- |
| 0 | подготовка БЗ (по [ADR-007](../../adr/007-kb-standard.md)) | — | Извлечь факты из 2 PDF, собрать выжимку, работать только с ней | [`inputs/kb-files.md`](./inputs/kb-files.md) |
...
| — | консолидация (ручная) | — | Сборка итогового артефакта раннего разбора + рекомендация | [`final-artifact.md`](./final-artifact.md) |
...
- **Шаг 2 — нормализация.** Отдельного промпта «нормализация требования» в библиотеке
  ...
  (см. [RFC](../../../governance/rfc/prompt-improvement-multichannel-proposal.md)).
