...
| [BCREQ-1059: Email-маршрутизация по Точке входа](./bcreq-1059-email-routing/README.md) | Оператор отвечает с ящика Точки входа входящего письма; автомаршрутизация в КЦ | Финальное ТЗ (Разделы 1, 2, 4, 6) + анализ 5 паттернов ошибок и 6 инсайтов | [issue #113](https://github.com/G-Ivan-A/mango_ba_prompts/issues/113) |
