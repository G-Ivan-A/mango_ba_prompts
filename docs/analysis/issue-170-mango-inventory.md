...
related_artifacts:
  ...
  - "kb/mango/mango-registry.schema.json"
  - "kb/mango/README.md"
...
> Документ сгенерирован из живого реестра скриптом [`experiments/gen_inventory_doc.py`](../../experiments/gen_inventory_doc.py) и отражает [`kb/mango/mango-registry.json`](../../kb/mango/mango-registry.json) один-в-один. Перегенерируйте после изменения реестра.
...
Итог — единый файл [`kb/mango/mango-registry.json`](../../kb/mango/mango-registry.json) (версия `1.0.0`) со следующим наполнением:
...
2. **JSON Schema, draft 2020-12** — [`kb/mango/mango-registry.schema.json`](../../kb/mango/mango-registry.schema.json).
3. **Полный контур БЗ:**
   ```bash
   make kb-validate
   ```
