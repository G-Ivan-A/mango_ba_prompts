...
### Размещение на многостраничном SPA (интеграция с issue #99)

После issue #99 GitHub Pages — многостраничный SPA (hash-роутер
`#catalog/#dashboard/#roadmap/#processes/#patterns`). Дерево ФТ-8 встроено
отдельной полосой (`#process-tree-panel`, `data-page="processes"`) на странице
«Процессы» — под карточками процессов issue #99, без дублирования пункта
навигации. Скриншот всей страницы «Процессы» (карточки issue #99 сверху, полоса
ФТ-8 в свёрнутом виде снизу):

![Страница «Процессы» SPA: карточки issue #99 и полоса ФТ-8](../screenshots/issue-97-spa-processes-page.png)
