...
Карта связывает 9 процессов БА, 13 когнитивных операций, 24 активных prompt-файла,
6 архивных legacy-файлов и направления разработки из
