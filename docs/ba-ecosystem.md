...
| Практика / правило | Практика рекомендует и допускает адаптацию; правило обязательно и проверяется в review. | Founder / reviewer |
| Уровень зрелости | Способ исполнения: ручные промпты, системный prompt+KB, агент, мультиагентный контур. | Founder + BA lead |
