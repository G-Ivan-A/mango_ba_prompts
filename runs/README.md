...
| [`RUN-0020`](2026/RUN-0020/metadata.yaml) | 2026-07-10 | `statistics` | fr-drafting-975-ineffective-call-parameters | [`outputs/README.md`](2026/RUN-0020/outputs/README.md), [`outputs/final-artifact.md`](2026/RUN-0020/outputs/final-artifact.md), [`feedback/review-notes.md`](2026/RUN-0020/feedback/review-notes.md), [`logs/metrics.md`](2026/RUN-0020/logs/metrics.md) |
...
| [`experiments/parse_qwen_chat_export.py`](../experiments/parse_qwen_chat_export.py) | Считает токены (`tiktoken:cl100k_base`), длительности и метрики по эпизодам из выгрузки чата Qwen. Используется в [`RUN-0018`](2026/RUN-0018/logs/metrics.md) и [`RUN-0020`](2026/RUN-0020/logs/metrics.md). |
