...
| [`RUN-0024`](2026/RUN-0024/metadata.yaml) | 2026-08-21 | `statistics` | fr-drafting-58093-amocrm-deal-card-new-tab | [`outputs/README.md`](2026/RUN-0024/outputs/README.md), [`outputs/quality-findings.md`](2026/RUN-0024/outputs/quality-findings.md), [`logs/metrics.md`](2026/RUN-0024/logs/metrics.md) |
...
| [`experiments/parse_58093_chat_export.py`](../experiments/parse_58093_chat_export.py) | Считает метрики по эпизодам (токены провайдера, время генерации, активное время) из выгрузки чата задачи 58093. Используется в [`RUN-0024`](2026/RUN-0024/logs/metrics.md). |
