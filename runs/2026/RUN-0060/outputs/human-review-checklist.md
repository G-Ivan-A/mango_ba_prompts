...
| --- | --- | --- |
| A | Тип A — ссылка ведёт на неверный объект | 0 |
...
| OK | Без замечаний — ссылка ведёт прямо на описанный объект | 23 |
| **Итого** | | **53** |
...
| 39 | 9.3 | `^7` | Раздел «Просмотр резюме с контактами» (ссылка из описания `get-resume`) | описанный объект виден на странице ссылки без дополнительных шагов | OK | исправление не требуется |
