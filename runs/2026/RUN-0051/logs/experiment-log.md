...
# Журнал фиксации прогона RUN-0051

## Цель

Зафиксировать экспорт чата `960-chat-export-1787301855482.json` отдельной записью прогона с `run_type: statistics` (issue #309): накопить статистику применения промптов и операций процесса БА.

## Шаги

1. Вложение issue скачано и разобрано как JSON; экспорт читаем, ветка диалога восстановлена по `parentId` — 114 реплик.
...
- диалог шёл с 2026-02-17 по 2026-04-08 (11 рабочих сессий);
